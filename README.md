...
Hybrid Fake News Detection & Truth Verification System

In this project, we have used various natural language processing techniques and machine learning algorithms to classify fake news articles using sci-kit libraries from python. 

## About Yudhishthira AI

“Truth Beyond Headlines”

Yudhishthira AI is a hybrid misinformation detection platform that combines ML classification with live internet verification and trusted-source analysis.
